  ...
  describe('XHRBackend', () => {
    ...
    describe('XHRConnection', () => {
      ...
      it('should call send on the backend with request body when subscribed to', () => {
        ...
        var base = new BaseRequestOptions();
        var connection = new XHRConnection(new Request(base.merge(new RequestOptions({body: body}))),
                          new MockBrowserXHR());
        expect(openSpy).not.toHaveBeenCalled();
        connection.response.subscribe();
      ...
      it('should attach headers to the request', () => {
        ...
        var base = new BaseRequestOptions();
        var connection = new XHRConnection(new Request(base.merge(new RequestOptions({headers: headers}))),
                          new MockBrowserXHR());
        connection.response.subscribe();
