...
export class OfflineCompiler {
  ...
  compile(
    ...
    exportedVars.push(
        ...ngModules.map((ngModuleType) => this._compileNgModule(ngModuleType, statements)));
  ...
  private _compileNgModule(ngModuleType: StaticSymbol, targetStatements: o.Statement[]): string {
