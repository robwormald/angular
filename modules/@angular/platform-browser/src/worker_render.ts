...
import {ExceptionHandler, Injectable, Injector, NgZone, OpaqueToken, PLATFORM_CORE_PROVIDERS, PLATFORM_INITIALIZER, PlatformRef, ReflectiveInjector, RootRenderer, Testability, assertPlatform, createPlatform, createPlatformFactory, getPlatform, isDevMode} from '@angular/core';
...
const _workerUiPlatform = createPlatformFactory('workerUi', WORKER_UI_PLATFORM_PROVIDERS);

/**
 * @experimental WebWorker support is currently experimental.
 */
export const workerUiPlatform = (workerScriptUri: string, extraProviders: any[] = []) =>
    _workerUiPlatform([{provide: WORKER_SCRIPT, useValue: workerScriptUri}, extraProviders]);
