...
export declare class SelectorMatcher {
    ...
    */
    ...
    /** @internal */
    _matchTerminal(map: Map<string, SelectorContext[]>, name: string, cssSelector: CssSelector, matchedCallback: (c: CssSelector, a: any) => void): boolean;
    /** @internal */
    _matchPartial(map: Map<string, SelectorMatcher>, name: string, cssSelector: CssSelector, matchedCallback: (c: CssSelector, a: any) => void): boolean;
}
