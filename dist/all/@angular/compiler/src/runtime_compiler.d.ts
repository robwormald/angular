 ...
 */
import { ComponentFactory, Injector, NgModuleFactory, NgModuleMetadata } from '@angular/core';
...
export declare class RuntimeCompiler {
     ...
     * @internal
     */
    _compileComponentInModule<T>(compType: ConcreteType<T>, isSync: boolean, moduleType: ConcreteType<any>): SyncAsyncResult<ComponentFactory<T>>;
    /**
     * @internal
     */
