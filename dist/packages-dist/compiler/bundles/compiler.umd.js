    ...
    */
    ...
    var NgModuleCompiler = (function () {
        ...
        NgModuleCompiler.prototype.compile = function (ngModuleMeta, extraProviders) {
            ...
            var providerParser = new NgModuleProviderParser(ngModuleMeta, extraProviders, sourceSpan);
    ...
    var RuntimeCompiler = (function () {
        ...
        RuntimeCompiler.prototype._compileNgModule = function (moduleType) {
            ...
            if (!ngModuleFactory) {
                ...
                var boundCompilerFactory = function (parentResolver) { return new CoreCompiler(_this, moduleMeta_1.type.runtime, parentResolver, _this._console); };
                ...
                COMPILER_PROVIDERS, {
                    ...
                    useFactory: function () {
                        return new CompilerConfig({
                            ...
                            genDebugInfo: _firstDefined(options.useDebug, _angular_core.isDevMode()),
                            // let explicit values from the compiler options overwrite options
                            // from the app providers
                            useJit: _firstDefined(options.useJit, true),
                            // let explicit values from the compiler options overwrite options
                            // from the app providers
                            defaultEncapsulation: _firstDefined(options.defaultEncapsulation, _angular_core.ViewEncapsulation.Emulated),
                            logBindingUpdate: _firstDefined(options.useDebug, _angular_core.isDevMode())
                        });
                    },
                    deps: []
                },
