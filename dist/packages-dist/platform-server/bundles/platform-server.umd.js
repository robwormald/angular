...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/compiler'), require('@angular/core'), require('@angular/platform-browser-dynamic/testing'), require('@angular/platform-browser')) :
        typeof define === 'function' && define.amd ? define(['exports', '@angular/common', '@angular/compiler', '@angular/core', '@angular/platform-browser-dynamic/testing', '@angular/platform-browser'], factory) :
            (factory((global.ng = global.ng || {}, global.ng.platformServer = global.ng.platformServer || {}), global._angular_common, global.ng.compiler, global.ng.core, global._angular_platformBrowserDynamic_testing, global.ng.platformBrowser));
}(this, function (exports, _angular_common, _angular_compiler, _angular_core, _angular_platformBrowserDynamic_testing, _angular_platformBrowser) {
    'use strict';
    ...
    var SERVER_PLATFORM_PROVIDERS = [
        _angular_core.PLATFORM_CORE_PROVIDERS,
    ...
    function serverBootstrap(appComponentType, customProviders) {
        ...
        DynamicModule.decorators = [
            { type: _angular_core.NgModule, args: [{
                        ...
                        imports: [_angular_platformBrowserDynamic_testing.BrowserDynamicTestModule],
                        precompile: [appComponentType]
                    },] },
        ];
        return _angular_core.bootstrapModule(DynamicModule, serverDynamicPlatform(), compilerOptions)
