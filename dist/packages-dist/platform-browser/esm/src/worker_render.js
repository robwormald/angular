 ...
 */
import { ExceptionHandler, Injectable, Injector, NgZone, OpaqueToken, PLATFORM_CORE_PROVIDERS, PLATFORM_INITIALIZER, RootRenderer, Testability, createPlatformFactory, isDevMode } from '@angular/core';
 ...
 * @experimental WebWorker support is currently experimental.
 */
export const workerUiPlatform = (workerScriptUri, extraProviders = []) => _workerUiPlatform([{ provide: WORKER_SCRIPT, useValue: workerScriptUri }, extraProviders]);
