...
var DiffingPluginWrapper = (function () {
    ...
    DiffingPluginWrapper.prototype.getDiffResult = function () {
        ...
        var returnOrCalculateDiffResult = function (tree, index) {
            ...
            var diffResult = _this.diffResult;
            if (diffResult)
                return diffResult;
            var differ = index === -1 ? _this.treeDiffer : _this.treeDiffers[index];
    ...
    DiffingPluginWrapper.prototype.init = function () {
        if (!this.initialized) {
            ...
            if (this.inputPaths) {
                this.treeDiffers = this.inputPaths.map(function (inputPath) {
                    return new tree_differ_1.TreeDiffer(description_1, inputPath, includeExtensions_1, excludeExtensions_1);
                });
            }
